...
[Request example](examples/POST__v1_product_certification_list_req.json)
...
| Field | Type | Req | Description |
|-------|------|-----|-------------|
| `result` | ProductCertificationListResponseCertificationResult |  | Результат запроса. |

[Response 200](../_shared/examples/POST__v1_product_certification_list_200.json)
