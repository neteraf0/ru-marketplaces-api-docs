...
|-------|------|-----|-------------|
| `certificate_id` | integer | ✓ | Идентификатор сертификата, который был присвоен при его загрузке. |
| `product_id` | array | ✓ | Массив идентификаторов товаров, к которым относится этот сертификат. |

[Request example](examples/POST__v1_product_certificate_bind_req.json)
