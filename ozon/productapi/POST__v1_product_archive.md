...
|-------|------|-----|-------------|
| `product_id` | array | ✓ | Список идентификаторов товаров в системе Ozon — `product_id`.  Вы можете передать до 100 идентификаторов за раз. |

[Request example](examples/POST__v1_product_archive_req.json)
