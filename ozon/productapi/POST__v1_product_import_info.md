...
|-------|------|-----|-------------|
| `task_id` | integer | ✓ | Код задачи на импорт товаров. Можно получить с помощью метода [/v3/product/import](#operation/ProductAPI_ImportProductsV3). |

[Request example](examples/POST__v1_product_import_info_req.json)
...
[Response 200](../_shared/examples/POST__v1_product_import_info_200.json)
