...
| Field | Type | Req | Description |
|-------|------|-----|-------------|
| `delivery_interval` | v1PostingFbsTimeslotChangeRestrictionsDeliveryInterval |  | Период дат, доступных для переноса. |
| `remaining_changes_count` | integer |  | Количество оставшихся переносов. |

[Response 200](../_shared/examples/POST__v1_posting_fbs_timeslot_change_restrictions_200.json)
