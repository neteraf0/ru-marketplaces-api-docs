...
| `from_message_id` | integer |  | Идентификатор сообщения. |

[Request example](examples/POST__v2_chat_read_req.json)
...
| Field | Type | Req | Description |
|-------|------|-----|-------------|
| `unread_count` | integer |  | Количество непрочитанных сообщений в чате. |

[Response 200](../_shared/examples/POST__v2_chat_read_200.json)
