...
[Request example](examples/POST__v1_brand_company_certification_list_req.json)
...
| Field | Type | Req | Description |
|-------|------|-----|-------------|
| `result` | BrandCompanyCertificationListResponseBrandCertificationResult |  | Результат запроса. |

[Response 200](../_shared/examples/POST__v1_brand_company_certification_list_200.json)
