...
| Field | Type | Req | Description |
|-------|------|-----|-------------|
| `errors` | array |  | Ошибки, возникшие при проверке. |
| `is_active` | boolean | ✓ | `true`, если URL-адрес активен.  |

[Response 200](../_shared/examples/POST__v1_notification_check_200.json)
