...
|-------|------|-----|-------------|
| `skus` | array | ✓ | Список идентификаторов товара в системе Ozon — SKU. |
## Responses
...
| Field | Type | Req | Description |
|-------|------|-----|-------------|
| `stairways` | array |  | Информация о скидке от количества по конкретному товару. |

[Response 200](../_shared/examples/POST__v1_product_stairway_discount_by_quantity_get_200.json)
