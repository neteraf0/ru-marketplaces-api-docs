...
| `filter` | v1WarehouseFbsPickUpHistoryListRequestFilter |  | Фильтр. |
...
| Field | Type | Req | Description |
|-------|------|-----|-------------|
| `result` | v1WarehouseFbsPickUpHistoryListResponseResult |  | Результат метода. |

[Response 200](../_shared/examples/POST__v1_warehouse_fbs_pickup_history_list_200.json)
