...
| `filter` | productv5Filter | ✓ | Фильтр по товарам. |
| `limit` | integer | ✓ | Количество значений на странице. |

[Request example](examples/POST__v5_product_info_prices_req.json)
...
[Response 200](../_shared/examples/POST__v5_product_info_prices_200.json)
