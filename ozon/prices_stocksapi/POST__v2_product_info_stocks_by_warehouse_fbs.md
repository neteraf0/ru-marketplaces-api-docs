...
**operationId:** `ProductAPI_GetProductInfoStocksByWarehouseFbsV2`
...
| `offer_id` | array |  | Идентификаторы товаров в системе продавца — артикул. |
...
| `products` | array |  | Остатки товаров. |

[Response 200](../_shared/examples/POST__v2_product_info_stocks_by_warehouse_fbs_200.json)
