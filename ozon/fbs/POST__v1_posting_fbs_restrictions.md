...
|-------|------|-----|-------------|
| `posting_number` | string | ✓ | Номер отправления, для которого нужно определить ограничения. |

[Request example](examples/POST__v1_posting_fbs_restrictions_req.json)
...
[Response 200](../_shared/examples/POST__v1_posting_fbs_restrictions_200.json)
