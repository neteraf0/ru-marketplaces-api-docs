...
| `with` | postingv3FbsPostingWithParamsExamplars |  | Дополнительные поля, которые нужно добавить в ответ. |

[Request example](examples/POST__v3_posting_fbs_get_req.json)
...
[Response 200](../_shared/examples/POST__v3_posting_fbs_get_200.json)
