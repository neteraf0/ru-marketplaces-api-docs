...
|-------|------|-----|-------------|
| `posting_number` | array | ✓ | Идентификатор отправления. Максимальное количество в одном запросе — 100. |

[Request example](examples/POST__v2_posting_fbs_awaiting_delivery_req.json)
