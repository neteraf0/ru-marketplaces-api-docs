...
[Request example](examples/POST__v1_posting_unpaid_legal_product_list_req.json)
...
| Field | Type | Req | Description |
|-------|------|-----|-------------|
| `products` | array |  | Список неоплаченных товаров. |
| `cursor` | string |  | Указатель для выборки следующих данных. |

[Response 200](../_shared/examples/POST__v1_posting_unpaid_legal_product_list_200.json)
