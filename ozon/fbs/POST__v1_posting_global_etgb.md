...
|-------|------|-----|-------------|
| `date` | GetEtgbRequestDate | ✓ | Фильтр по периоду создания деклараций. |

[Request example](examples/POST__v1_posting_global_etgb_req.json)
...
[Response 200](../_shared/examples/POST__v1_posting_global_etgb_200.json)
