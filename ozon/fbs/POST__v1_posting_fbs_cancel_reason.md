...
|-------|------|-----|-------------|
| `related_posting_numbers` | array | ✓ | Номера отправлений. |

[Request example](examples/POST__v1_posting_fbs_cancel_reason_req.json)
...
[Response 200](../_shared/examples/POST__v1_posting_fbs_cancel_reason_200.json)
