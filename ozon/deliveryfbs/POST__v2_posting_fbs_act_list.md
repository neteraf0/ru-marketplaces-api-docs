...
|-------|------|-----|-------------|
| `filter` | v2PostingFBSActListFilter |  | Параметры фильтра. |
| `limit` | integer | ✓ | Максимальное количество актов в ответе. |

[Request example](examples/POST__v2_posting_fbs_act_list_req.json)
...
[Response 200](../_shared/examples/POST__v2_posting_fbs_act_list_200.json)
