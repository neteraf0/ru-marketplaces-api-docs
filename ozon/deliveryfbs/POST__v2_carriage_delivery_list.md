...
**operationId:** `CarriageAPI_CarriageDeliveryListV2`
...
| `filter` | CarriageDeliveryListV2RequestFilter |  | Фильтр для поиска методов доставки и отгрузок. |
...
| `methods` | array |  | Список методов доставки. |

[Response 200](../_shared/examples/POST__v2_carriage_delivery_list_200.json)
