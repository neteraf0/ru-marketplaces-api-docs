...
| `cancelledOrders` | query | boolean |  | Возвращать ли отмененные заказы.  Значение по умолчанию: `true`. Если возвращать отмененные заказы не нужно, передайте значение `false`.  |
...
[Response 200](../_shared/examples/GET__v2_campaigns__campaignId__first_mile_shipments__shipmentId_200.json)
