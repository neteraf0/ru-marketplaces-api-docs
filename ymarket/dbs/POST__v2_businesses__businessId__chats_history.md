...
|-------|------|-----|-------------|
| `messageIdFrom` | integer |  | Идентификатор сообщения, начиная с которого нужно получить все последующие сообщения. |
## Responses
...
[Response 200](../_shared/examples/POST__v2_businesses__businessId__chats_history_200.json)
