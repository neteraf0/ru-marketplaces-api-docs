...
|-------|------|-----|-------------|
| `orderIds` | array |  | Фильтр по идентификаторам заказов на Маркете. |
| `contexts` | array |  | Фильтр по контексту чата. |
| `contextTypes` | array |  | Фильтр по типу контекста чата. |
| `types` | array |  | Фильтр по типам чатов. |
| `statuses` | array |  | Фильтр по статусам чатов. |
## Responses
...
[Response 200](../_shared/examples/POST__v2_businesses__businessId__chats_200.json)
