...
| `offer_id` | query | array |  | Идентификатор скрытого предложения.  |
...
[Response 200](../_shared/examples/GET__v2_campaigns__campaignId__hidden_offers_200.json)
