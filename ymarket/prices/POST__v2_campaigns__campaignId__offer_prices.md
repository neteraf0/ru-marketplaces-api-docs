...
|-------|------|-----|-------------|
| `offerIds` | array |  | Список SKU.  {% note warning "Такой список возвращается только целиком" %}  Если вы запрашиваете информацию по конкретным SKU, не заполняйте:  * `page_token` * `limit`  {% endnote %}     |
## Responses
...
[Response 200](../_shared/examples/POST__v2_campaigns__campaignId__offer_prices_200.json)
