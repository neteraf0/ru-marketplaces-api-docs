...
**Tag:** [business-offer-mappings](index.md)
...
|-------|------|-----|-------------|
| `offerIds` | array | ✓ | Список товаров, которые нужно поместить в архив. |
## Responses
...
[Response 200](../_shared/examples/POST__v2_businesses__businessId__offer_mappings_archive_200.json)
