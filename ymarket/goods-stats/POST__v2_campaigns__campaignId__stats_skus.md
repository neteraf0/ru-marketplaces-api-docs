...
|-------|------|-----|-------------|
| `shopSkus` | array | ✓ | Список ваших идентификаторов SKU.  |
## Responses
...
[Response 200](../_shared/examples/POST__v2_campaigns__campaignId__stats_skus_200.json)
