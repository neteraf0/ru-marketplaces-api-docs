...
|------|----|------|----------|-------------|
| `parentId` | query | integer | ✓ | Parent category ID *Example: `1`* |
...
[Response 400: MissingParentId](../_shared/examples/GET__api_v1_analytics_brand_share_400_MissingParentId.json)
