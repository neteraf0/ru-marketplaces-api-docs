...
The method returns a report with [warehouse measurements](https://seller.wildberries.ru/analytics-reports/dimensions-penalties/warehouse-measurements)
...
| `limit` | query | integer | ✓ | Number of measurements in the response *Example: `330`* |
...
[Response 200: Measurements](../_shared/examples/GET__api_analytics_v1_warehouse_measurements_200_Measurements.json)
