...
| `isAnswered` | query | boolean |  | If the question was answered:   - `true` — yes   - `false` — no  |
...
|-------|------|-----|-------------|
| `data` | integer |  | Number of questions *Example: `77`* |
| `error` | boolean |  | Error presence |
| `errorText` | string |  | Error description |
| `additionalErrors` | array |  | Additional errors |

[Response 200](../_shared/examples/GET__api_v1_questions_count_200.json)
