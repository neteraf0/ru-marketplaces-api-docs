...
| `nmId` | query | integer |  | WB article *Example: `5870243`* |
| `take` | query | integer | ✓ | Number of feedbacks (max. 5 000) *Example: `1`* |
| `skip` | query | integer | ✓ | Number of feedbacks for skip (max. 199990) |
...
[Response 200](../_shared/examples/GET__api_v1_feedbacks_200.json)
