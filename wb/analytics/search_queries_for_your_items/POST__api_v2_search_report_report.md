...
| `subjectIds` | array |  | List of subject IDs for filtering *Example: `[32, 64]`* |
| `brandNames` | array |  | List of brands for filtering *Example: `['Adidas', 'Nike']`* |
| `tagIds` | array |  | List of label IDs for filtering *Example: `[3, 5, 6]`* |
...
[Response 200](../_shared/examples/POST__api_v2_search_report_report_200.json)
